...
- **Mama Mboga Mobile App:** A mobile app for vendors to manage inventory, orders, and sales.
...
1. Download the Gorzo mobile app from the device's app store
2. Open the application and click **Register** to create a new vendor account.
3. Fill in required details, including name, location, and contact.
4. Once registered, log in with your credentials to access your dashboard.

![alt text](<Images/role in hapa app.png>)
...
![alt text](<Images/mama mboga followup.png>)
...
![alt text](<Images/customer journey.png>)

## Need Help?

- Visit our [FAQs](faqs.md) for common questions. 
